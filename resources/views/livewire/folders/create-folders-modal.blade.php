    ...
    <form wire:submit.prevent="createFolder">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-5 gap-2 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg max-h-48 overflow-y-auto border border-gray-300 dark:border-gray-600">
                @foreach($availableIcons as $availableIcon)
                    <button 
                        type="button"
                        wire:click="selectIcon(@js($availableIcon))"
        ...
        <div class="flex justify-end space-x-3">
            ...
            >
                ...
                <span wire:loading.remove wire:target="createFolder">Criar Pasta</span>
                <span wire:loading wire:target="createFolder">A criar...</span>
            </button>
        </div>
    </form>
</div>