...
<div wire:click="" class="cursor-pointer bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        {{-- Edit Option --}}
                        <button wire:click="$dispatch('openModal', { component: 'projects.edit-projects-modal', arguments: { projectId: {{ $project->id }} } })"
