<div class="p-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-xl">
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-2xl font-bold mb-2">Editar Álbum</h2>
        <p class="text-gray-600 dark:text-gray-400">
            Atualiza as informações do álbum <strong>{{ $album->title }}</strong>
        </p>
    </div>
    ...
    <form wire:submit.prevent="updateAlbum">
        ...
        <div class="mb-6">
            ...
            @if($existing_cover && !$cover_image)
                <div class="mb-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Imagem atual:</p>
                    <img src="{{ Storage::url($existing_cover) }}" class="h-32 w-32 object-cover rounded-lg">
                </div>
            @endif
                ...
                <div class="text-center">
                    ...
                    <div class="mt-4 flex text-sm leading-6 text-gray-600 dark:text-gray-400">
                        <label for="cover_image" class="relative cursor-pointer rounded-md font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-500">
                            <span>{{ $cover_image ? 'Mudar imagem' : 'Carregar nova imagem' }}</span>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button
                ...
                <span wire:loading.remove wire:target="updateAlbum">Atualizar Álbum</span>
                <span wire:loading wire:target="updateAlbum">A atualizar...</span>
            </button>
        </div>
    </form>
</div>